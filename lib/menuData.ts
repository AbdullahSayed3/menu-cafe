...
const menu:MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: { ar: "فريش مانجو", en: "Fresh Mango" }, price: 85, image: "/images/Fresh/fresh_mango.png" },
      { name: { ar: "فريش فراولة", en: "Fresh Strawberry" }, price: 75, image: "/images/Fresh/fresh_strawberry.png" },
      { name: { ar: "فريش كيوي", en: "Fresh Kiwi" }, price: 95, image: "/images/Fresh/fresh_kiwi.png" },
      { name: { ar: "فريش برتقال", en: "Fresh Orange" }, price: 75, image: "/images/Fresh/fresh_orange.png" },
  ...
  },
{
...

  {
    ...
    items: [
      ...
      { name: { ar: "أم علي صغيرة", en: "Small Om Ali" }, price: 85, image: "/images/om_ali_small.jpg" },
      { name: { ar: "بليلة", en: "Belila" }, price: 50, image: "/images/belila.jpg" },
      { name: { ar: "مولتن كيك", en: "Molten Cake" }, price: 85, image: "/images/molten_cake.jpg" },
      { name: { ar: "مولتن كيك نوتيلا", en: "Nutella Molten Cake" }, price: 95, image: "/images/nutella_molten_cake.jpg" },
