...
const menu:MenuCategory[] = [
  {
    ...
    items: [
      { name: { ar: "ميلك شيك أوريو", en: "Oreo Milkshake" }, price: 110, image: "/images/oreo_milkshake.png", description: "Milkshake with Oreo cookies" },
      { name: { ar: "ميلك شيك كراميل", en: "Caramel Milkshake" }, price: 95, image: "/images/caramel_milkshake.jpg" },
      { name: { ar: "ميلك شيك فانيلا", en: "Vanilla Milkshake" }, price: 95, image: "/images/vanilla_milkshake.png" },
      { name: { ar: "ميلك شيك لوتس", en: "Lotus Milkshake" }, price: 110, image: "/images/lotus_milkshake.webp", description: "Creamy milkshake with Lotus biscuit spread" },
      { name: { ar: "ميلك شيك شوكلت", en: "Chocolate Milkshake" }, price: 95, image: "/images/chocolate_milkshake.jpg",description: "Milkshake with rich chocolate flavor" },
      { name: { ar: "ميلك شيك فواكه", en: "Fruit Milkshake" }, price: 110, image: "/images/fruit_milkshake.jpg" },
      { name: { ar: "ميلك شيك فستق", en: "Pistachio Milkshake" }, price: 110, image: "/images/pistachio_milkshake.jpg" },
      { name: { ar: "ميلك شيك فراولة", en: "Strawberry Milkshake" }, price: 90, image: "/images/strawberry_milkshake.jpg" },
      { name: { ar: "ميلك شيك كيوي", en: "Kiwi Milkshake" }, price: 90, image: "/images/kiwi_milkshake.jpg" },
      { name: { ar: "ميلك شيك خوخ", en: "Peach Milkshake" }, price: 90, image: "/images/peach_milkshake.jpg" },
      { name: { ar: "ميلك شيك بلوبيري", en: "Blueberry Milkshake" }, price: 90, image: "/images/blueberry_milkshake.jpg" },
      { name: { ar: "ميلك شيك راسبيري", en: "Raspberry Milkshake" }, price: 90, image: "/images/raspberry_milkshake.jpg" },
      { name: { ar: "ميلك شيك مانجو", en: "Mango Milkshake" }, price: 90, image: "/images/mango_milkshake.jpg" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: { ar: "فريش أفوكادو", en: "Fresh Avocado" }, price: 110, image: "/images/fresh_avocado.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: { ar: "اسموزي باشون", en: "Passion Smoothie" }, price: 85, image: "/images/passion_smoothie.jpg" },
      { name: { ar: "اسموزي ليمون نعناع", en: "Lemon Mint Smoothie" }, price: 75, image: "/images/lemon_mint_smoothie.jpg" },
      { name: { ar: "اسموزي كيوي", en: "Kiwi Smoothie" }, price: 75, image: "/images/kiwi_smoothie.jpg" },
      { name: { ar: "اسموزي مانجو", en: "Mango Smoothie" }, price: 80, image: "/images/mango_smoothie.jpg" },
      { name: { ar: "اسموزي فراولة", en: "Strawberry Smoothie" }, price: 80, image: "/images/strawberry_smoothie.jpg" },
      { name: { ar: "اسموزي بطيخ", en: "Watermelon Smoothie" }, price: 80, image: "/images/watermelon_smoothie.jpg" },
      ...
      { name: { ar: "اسموزي ميكس", en: "Mix Smoothie" }, price: 90, image: "/images/mix_smoothie.jpg",description:"" },
    ],
  },
{
...

  {
    ...
    items: [
      ...
      { name: { ar: "مولتن كيك", en: "Molten Cake" }, price: 75, image: "/images/molten_cake.jpg" },
  ...
  { name: { ar: "شاي بحليب", en: "Milk Tea" }, price: 60, image: "/images/milk_tea.jpg" },  // جديد
  ...
  { name: { ar: "سبانيش لاتيه", en: "Spanish Latte" }, price: 60, image: "/images/spanish_latte.jpg" }, // جديد
  { name: { ar: "فلات وايت", en: "Flat White" }, price: 65, image: "/images/flat_white.jpg" },
  { name: { ar: "أمريكان كوفي", en: "American Coffee" }, price: 65, image: "/images/american_coffee.jpg" },
...

{
  ...
  items: [
    ...
    { name: { ar: "V كولا", en: "V Cola" }, price: 45, image: "/images/v_cola.jpg" },       
...
},
{
  ...
  items: [
    { name: { ar: "ايس لاتيه", en: "Iced Latte" }, price: 85, image: "/images/iced_latte.jpg" },
    { name: { ar: "ايس موكا", en: "Iced Mocha" }, price: 85, image: "/images/iced_mocha.jpg" },
    { name: { ar: "ايس كوفي", en: "Iced Coffee" }, price: 80, image: "/images/iced_coffee.jpg" },
  ],
},
{
