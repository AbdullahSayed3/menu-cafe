...
const menu:MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: { ar: "ميلك شيك شوكلت", en: "Chocolate Milkshake" }, price: 100, image: "/images/chocolate_milkshake.jpg",description: "Milkshake with rich chocolate flavor" },
      ...
      { name: { ar: "ميلك شيك فراولة", en: "Strawberry Milkshake" }, price: 100, image: "/images/strawberry_milkshake.jpg" },
      ...
      { name: { ar: "ميلك شيك بلوبيري", en: "Blueberry Milkshake" }, price: 100, image: "/images/blueberry_milkshake.jpg" },
      { name: { ar: "ميلك شيك راسبيري", en: "Raspberry Milkshake" }, price: 90, image: "/images/raspberry_milkshake.jpg" },
      { name: { ar: "ميلك شيك مانجو", en: "Mango Milkshake" }, price: 100, image: "/images/mango_milkshake.jpg" },
    ],
  },
  {
    category: { ar: "عصائر فريش", en: "Fresh Juices" },
    items: [
      { name: { ar: "فريش مانجو", en: "Fresh Mango" }, price: 70, image: "/images/fresh_mango.jpg" },
      { name: { ar: "فريش فراولة", en: "Fresh Strawberry" }, price: 70, image: "/images/fresh_strawberry.jpg" },
      { name: { ar: "فريش كيوي", en: "Fresh Kiwi" }, price: 70, image: "/images/fresh_kiwi.jpg" },
      ...
      { name: { ar: "فريش أفوكادو", en: "Fresh Avocado" }, price: 90, image: "/images/fresh_avocado.jpg" },
      { name: { ar: "فريش ليمون نعناع", en: "Fresh Lemon Mint" }, price: 70, image: "/images/fresh_lemon_mint.jpg" },
      ...
      { name: { ar: "سلطة فواكه", en: "Fruit Salad" }, price: 85, image: "/images/fruit_salad.jpg" },
    ],
  },
  {
